...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitdinar-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitdinar-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitdinar transaction") + "\n" +
              "  bitdinar-tx [options] -create [commands]   " + _("Create hex-encoded bitdinar transaction") + "\n" +
              "\n";
