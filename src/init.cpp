...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitdinar-project/bitdinar>";
    const std::string URL_WEBSITE = "<https://bitdinar.org>";
