...
const char * const BITCOIN_CONF_FILENAME = "bitdinar.conf";
const char * const BITCOIN_PID_FILENAME = "bitdinar.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BitDinar";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BitDinar";
#else
    // Unix
    return pathRet / ".bitdinar";
#endif
#endif
}
